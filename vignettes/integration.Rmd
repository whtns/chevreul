...
```{r }
markerp <- plot_markers(human_gene_transcript_sce, group_by = "gene_snn_res.0.2", num_markers = 10)

dp <- plot_var(human_gene_transcript_sce, group = "gene_snn_res.0.2")
...
```{r, eval=TRUE}
plot_var(human_gene_transcript_sce, group = "Prep.Method", )
```
