...
*** include text to indicate that we will be going through sections in the app and providing info 

### Integrate Projects

Integration of 2 or more single-cell datasets is important for its joint analyses. Choices of cell-level and batch-level qc are highly relevant when performing batch integration. 
...
This section of Chevreul, includes a list of projects which can be filtered through to select and run the integration.
...
Chevreul provides different methods of differential expression analysis that users can choose from to determine differential expression of gene. DE methods included in Chvreul are t-test, Wilcoxon rank-sum test, Likelihood ratio test, and MAST
