...
Chevreul allows exploratory data analysis of a single cell dataset processed using `SingleCellExperiment` with the command `minimalSingleCellExperimentApp()`
